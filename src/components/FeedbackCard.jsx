  ...
  return (
    <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0">
      ...
      <div className="flex flex-row">
        <div className="w-[48px] h-[48px] flex justify-center items-center bg-dark-gradient rounded-full" >
            <p className="font-montserrat font-semibold text-gradient text-[22px]">
                {name.split(" ").map(c => c[0]).join(".")}
            </p>
        </div>
